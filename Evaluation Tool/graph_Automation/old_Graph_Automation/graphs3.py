...
if file_name == "performance_Analysis.xlsx":
    ...
    for table_name in sheet_1.tables:
        ...
        x_labels_1.append(table_name.split("_")[0])
    ...
    for table_name in sheet_2.tables:
        ...
        x_labels_2.append(table_name.split("_")[1])
...
x_labels = [f"{x_labels_1[e]} / {x_labels_2[e]}" for e in range(len(x_labels_1))]
...
# Labels and legend
ax.set_xlabel('Number of encryptors / Size duplication', fontsize=12)
