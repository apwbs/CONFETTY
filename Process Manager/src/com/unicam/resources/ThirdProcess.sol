...
string deliver;
	...
	string[1] roleList = [ "Special carrier" ]; 
	string[4] optionalList = ["Supplier", "Manufacturer", "Middleman", "Bulk buyer" ];
...
constructor() public{
	...
	optionalRoles["Supplier"] = 0x0000000000000000000000000000000000000000;	optionalRoles["Manufacturer"] = 0x0000000000000000000000000000000000000000;	optionalRoles["Middleman"] = 0x0000000000000000000000000000000000000000;	optionalRoles["Bulk buyer"] = 0x0000000000000000000000000000000000000000;		//enable the start process
		Event_1dbiauq();
...
function Message_1rxxmav(string memory order) public checkRole(optionalList[3]) {
...
function Message_1sh89cl(string memory placed_order) public checkRole(optionalList[1]) {
...
function Message_0sdet47(string memory fwd_order) public checkRole(optionalList[2]) {
...
function Message_1kacyby(string memory transport_order) public checkRole(optionalList[2]) {
...
function Message_0b73gfv(string memory prov_details) public checkRole(optionalList[0]) {
...
function Message_1s263cb(string memory waybill) public checkRole(optionalList[0]) {
...
function Message_1fh103z(string memory report) public checkRole(optionalList[1]) {
...
function Message_0d2vwmq(string memory deliver) public checkRole(optionalList[1]) {
