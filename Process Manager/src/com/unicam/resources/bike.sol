...
constructor() public{
	...
	roles["Bike center"] = 0x9e80eBa685B1831f2718A248b18eA58aFD81864c;
	roles["Customer"] = 0x9e80eBa685B1831f2718A248b18eA58aFD81864c;
	optionalRoles["Insurer"] = 0x0000000000000000000000000000000000000000;		//enable the start process
		StartEvent_0gb8jks();
...
function Message_0lvlunm(string memory insuranceData) public checkRole(optionalList[0]){
