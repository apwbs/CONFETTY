...
string insuranceData;
	...
	string[3] roleList = [ "Customer", "BikeCenter", "Insurer" ]; 
...
constructor() public{
	...
	roles["Customer"] = 0x62AbA4475128080Dd4B59FA5D7E2fAEb2B720A21;
	roles["BikeCenter"] = 0x62AbA4475128080Dd4B59FA5D7E2fAEb2B720A21;
	roles["Insurer"] = 0x62AbA4475128080Dd4B59FA5D7E2fAEb2B720A21;
...
function Message_0l75vce(bool insuranceReq) public checkRole(roleList[0]) {
...
function Message_0hzpgno(string memory bikeId) public checkRole(roleList[1]) {
...
function Message_0cq2w1g(string memory description) public checkRole(roleList[0]) {
...
function Message_1ufjjj2(bool ask, uint amount) public checkRole(roleList[1]) {
...
function Message_0to30q0() public payable checkRole(roleList[0]) {
	require(elements[13].status==State.ENABLED);
	done(13);
roles["BikeCenter"].transfer(msg.value);
...
function Message_0g4xpdf(uint credits) public checkRole(roleList[1]) {
...
function Message_0is10sh(string memory data) public checkRole(roleList[1]) {
...
function Message_1989eur(string memory feedback) public checkRole(roleList[0]) {
...
function Message_1dp5xa4(string memory voucherId, string memory bike_Id) public checkRole(roleList[0]) {
...
function Message_009a0bz(uint insuranceCost) public checkRole(roleList[1]) {
...
function Message_0nkjynd() public payable checkRole(roleList[0]) {
	require(elements[23].status==State.ENABLED);  
	done(23);
roles["BikeCenter"].transfer(msg.value);
	enable("Message_0b1e9t1",26);
}
function Message_0b1e9t1(string memory voucherData) public checkRole(roleList[1]){
...
function Message_02ckm6k(string memory bikeType) public checkRole(roleList[0]) {
...
function Message_06bv1qa(bool isAvailable, uint cost) public checkRole(roleList[1]) {
...
function Message_0psi2ab() public payable checkRole(roleList[0]) {
	require(elements[25].status==State.ENABLED);  
	done(25);
roles["Insurer"].transfer(msg.value);
