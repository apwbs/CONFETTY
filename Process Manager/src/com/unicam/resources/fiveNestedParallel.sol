...
function ParallelGateway_15f9e3r() private { 
	...
	enable("ParallelGateway_0d5omc4", 10); 
ParallelGateway_0d5omc4(); 
	enable("ParallelGateway_10y4v1h", 11); 
ParallelGateway_10y4v1h(); 
	enable("ParallelGateway_10y4v1h", 11); 
ParallelGateway_10y4v1h(); 
}

function ParallelGateway_0d5omc4() private { 
	require(elements[10].status==State.ENABLED);
	done(10);
	enable("ParallelGateway_0j20i46", 12); 
ParallelGateway_0j20i46(); 
	enable("ParallelGateway_0j20i46", 12); 
ParallelGateway_0j20i46(); 
}
...
function ParallelGateway_10y4v1h() private { 
	...
	if( elements[12].status==State.DONE && elements[8].status==State.DONE && elements[8].status==State.DONE ) { 
	enable("ParallelGateway_1vnzhn2", 9); 
ParallelGateway_1vnzhn2(); 
}} 
...
function ParallelGateway_1vnzhn2() private { 
	...
	if( elements[11].status==State.DONE && elements[6].status==State.DONE && elements[6].status==State.DONE ) { 
	enable("ParallelGateway_0saxv30", 7); 
ParallelGateway_0saxv30(); 
}} 
...
function ParallelGateway_0j20i46() private { 
	require(elements[12].status==State.ENABLED);
	done(12);
	if( elements[10].status==State.DONE && elements[10].status==State.DONE ) { 
	enable("ParallelGateway_10y4v1h", 11); 
ParallelGateway_10y4v1h(); 
}} 
