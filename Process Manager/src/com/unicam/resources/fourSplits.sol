...
else if(currentMemory.a==1){enable("ExclusiveGateway_12jgl5c", 9); 
...
if(currentMemory.a==0){enable("EndEvent_1ufg2me", 10); 
 EndEvent_1ufg2me(); 
}
else if(currentMemory.a==1){enable("EndEvent_1qpsd1u", 11); 
 EndEvent_1qpsd1u(); 
}
}
