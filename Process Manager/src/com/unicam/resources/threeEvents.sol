...
constructor() public{
        elements[5] = Element("StartEvent_0e2atjt", State.ENABLED);
         //roles definition
...
currentMemory.par1=par1;
	enable("EventBasedGateway_0n7mixr",7);
