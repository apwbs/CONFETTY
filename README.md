...
## Wiki
For a detailed documentation and a step-by-step tutorial for configuring and testing this version locally, refer to Wiki.pdf or the [Wiki](https://github.com/apwbs/CONFETTY/wiki).
